...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t16101 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t16101 = (function (val,box,meta16102){
this.val = val;
this.box = box;
this.meta16102 = meta16102;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t16101.cljs$lang$type = true;
cljs.core.async.impl.channels.t16101.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t16101";
cljs.core.async.impl.channels.t16101.cljs$lang$ctorPrWriter = (function (this__3670__auto__,writer__3671__auto__,opt__3672__auto__){return cljs.core._write.call(null,writer__3671__auto__,"cljs.core.async.impl.channels/t16101");
});
cljs.core.async.impl.channels.t16101.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t16101.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16103){var self__ = this;
var _16103__$1 = this;return self__.meta16102;
});
cljs.core.async.impl.channels.t16101.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16103,meta16102__$1){var self__ = this;
var _16103__$1 = this;return (new cljs.core.async.impl.channels.t16101(self__.val,self__.box,meta16102__$1));
});
cljs.core.async.impl.channels.__GT_t16101 = (function __GT_t16101(val__$1,box__$1,meta16102){return (new cljs.core.async.impl.channels.t16101(val__$1,box__$1,meta16102));
});
}
return (new cljs.core.async.impl.channels.t16101(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_16104 = self__.takes.pop();if((taker_16104 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_16104))
{var take_cb_16105 = cljs.core.async.impl.protocols.commit.call(null,taker_16104);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_16105,taker_16104){
return (function (){return take_cb_16105.call(null,null);
});})(take_cb_16105,taker_16104))
);
} else
{}
{
