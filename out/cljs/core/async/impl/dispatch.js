...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_16095 = 0;while(true){
var m_16096 = cljs.core.async.impl.dispatch.tasks.pop();if((m_16096 == null))
{} else
{m_16096.call(null);
if((count_16095 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__16097 = (count_16095 + 1);
count_16095 = G__16097;
continue;
}
} else
{}
