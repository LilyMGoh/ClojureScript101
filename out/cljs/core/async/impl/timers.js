...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_16072 = 0;while(true){
if((i_16072 < arr.length))
{(arr[i_16072] = null);
{
var G__16073 = (i_16072 + 1);
i_16072 = G__16073;
continue;
}
} else
...
{var i_16079 = (self__.level + 1);while(true){
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_16081 = 0;while(true){
if((i_16081 <= self__.level))
{var links_16082 = (update[i_16081]).forward;if(((links_16082[i_16081]) === x__$1))
